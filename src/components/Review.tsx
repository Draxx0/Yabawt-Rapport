    ...
    <section className="container py-14 md:py-28" id={sectionName} ref={containerRef}>
      ...
      <div className="flex flex-col space-y-4">
        ...
        <p className="font-medium">
          Je souhaite en dernier lieu remercier Yabawt pour son accueil bienveillant et évidemment remercier l’équipe technique avec laquelle j’ai passé trois mois
